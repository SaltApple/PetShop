...
import com.shop.server.Model.ProductsExample.Criteria;
import com.shop.server.Model.ProductsExample.Criterion;
...
public class ProductsSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getProductNo() != null) {
            sql.SET("product_no = #{record.productNo,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Products record) {
        ...
        if (record.getPetId() != null) {
            sql.SET("pet_id = #{petId,jdbcType=INTEGER}");
        }
